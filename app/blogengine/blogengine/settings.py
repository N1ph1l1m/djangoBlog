...
SECRET_KEY = 'django-insecure-tcbp^r1+@$6ym83z3%e+u+pz)!g0#g8b)uv4#f7_i@-@o@=!p5'
...
REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CLASSES': [
        ...
        # 'rest_framework.renderers.BrowsableAPIRenderer',##влючение браузерного просмотра restframework
    ],
