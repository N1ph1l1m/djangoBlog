    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actors', models.ManyToManyField(related_name='film_actor', to='django_movie.actor', verbose_name='актеры')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='django_movie.actor', verbose_name='режисер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_movie.movie', verbose_name='фильм')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='django_movie.reies', verbose_name='Родитель')),
            ],
            options={
                'verbose_name': 'Отзыв',
